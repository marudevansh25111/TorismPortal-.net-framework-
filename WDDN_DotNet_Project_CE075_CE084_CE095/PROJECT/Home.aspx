...
<body class="background">
    <form id="form1" runat="server">
        <div class="topnav" style="width: 100%">
            ...
            <a>
                <asp:TextBox ID="sew_searchBox" runat="server" placeholder="Search..." BorderStyle="Groove" border-radius="30px" Font-Overline="True" Font-Size="25px" Width="253px"></asp:TextBox>
                &nbsp; &nbsp;</a><a><asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Style="font-size: 25px;" Height="40px" />
                </a>

             <div class="dropdown">
            <asp:dropdownlist id="DropDownList1" runat="server" autopostback="True" onselectedindexchanged="DropDownList1_SelectedIndexChanged" Height="40px" Width="253px" style="font-size:25px">

       <asp:listitem value="#">Destinations</asp:listitem>
                <asp:listitem value="goa.aspx">Goa</asp:listitem>

       <asp:listitem value="Taj Mahal.aspx">Taj Mahal</asp:listitem>

       <asp:listitem value="Statue Of Unity.aspx">Statue Of Unity</asp:listitem>
       <asp:listitem value="jaipur.aspx">Jaipur</asp:listitem>

       <asp:listitem value="kerela.aspx">Kerela</asp:listitem>

       <asp:listitem value="Khajuraho.aspx">Khajuraho</asp:listitem>
       <asp:listitem value="Leh Ladakh.aspx">Leh Ladakh</asp:listitem>

       <asp:listitem value="Sasan Gir.aspx">sasan Gir</asp:listitem>

       <asp:listitem value="North east India.aspx">North East India</asp:listitem>
...
The intensifying influence of tourism as an economic powerhouse and its potential as a tool for regional development are indisputable. It is growing progressively and contributing immensely to the inclusive economic development of the nation at one end and employment generation for the stakeholders on the other end. On the basis of its tourism resources and attractions, tourism in India can broadly be classified into cultural and heritage tourism, eco and sustainable tourism, religious/pilgrimage tourism, wildlife and nature-based tourism, medical tourism, leisure and beach tourism, MICE and event tourism, creative tourism, etc.
        ...
        <div class="iocon">
            <asp:ImageButton ID="ImageButton1" runat="server" Height="295px" ImageUrl="~/img/1386038.jpg" Style="margin-top: 0px; border: 5px solid #003366;" Width="432px" OnClick="ImageButton1_Click" PostBackUrl="~/Taj Mahal.aspx" />
            &nbsp;&nbsp;&nbsp;&nbsp;
           
            <asp:ImageButton ID="ImageButton2" runat="server" Height="295px" ImageUrl="~/img/mp.jpg" Style="border: 5px solid #003366;" Width="432px" PostBackUrl="~/Khajuraho.aspx" />
            &nbsp;&nbsp;&nbsp;&nbsp;
           
            <asp:ImageButton ID="ImageButton3" runat="server" Height="295px" ImageUrl="~/img/jaipur.jpg" Style="border: 5px solid #003366;" Width="432px" PostBackUrl="~/jaipur.aspx" />
            <br />
            <br />
            <br />
            <asp:ImageButton ID="ImageButton4" runat="server" Height="295px" ImageUrl="~/img/goa.jpeg" Style="border: 5px solid #003366;" Width="432px" PostBackUrl="~/goa.aspx" />
            &nbsp;&nbsp;&nbsp;&nbsp;
           
            <asp:ImageButton ID="ImageButton5" runat="server" Height="295px" ImageUrl="~/img/east india.jpg" Style="border: 5px solid #003366;" Width="432px" PostBackUrl="~/North east India.aspx" />
            &nbsp;&nbsp;&nbsp;&nbsp;
           
            <asp:ImageButton ID="ImageButton6" runat="server" Height="295px" ImageUrl="~/img/kerala1.jpg" Style="border: 5px solid #003366;" Width="432px" PostBackUrl="~/kerela.aspx" />
            <br />
            <br />
            <br />
            <br />
